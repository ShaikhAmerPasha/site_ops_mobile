<template>
	<div class="p-4">
		<PageHeader title="Material Issue">
			<template #action>
				<AppButton size="sm" @click="router.push('/stock-entries/new')">
		...
		<EmptyState
			...
			subtitle="Material you issue to site will show up here"
		>
			<AppButton size="sm" @click="router.push('/stock-entries/new')">Issue Material</AppButton>
		</EmptyState>
